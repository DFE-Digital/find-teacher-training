...
RSpec.describe TeacherTrainingPublicAPI::SyncAllProviders do
  ...
  describe '.call' do
    ...
    it 'calls TeacherTrainingPublicAPI::ProvidersCache and TeacherTrainingPublicAPI::SyncCheck' do
      ...
      stub_teacher_training_api_provider_names_and_codes(recruitment_cycle_year:)

      described_class.call(recruitment_cycle_year:)
    ...
    it 'raises a JsonApiClient::Errors::ApiError' do
      stub_teacher_training_api_provider_names_and_codes_timeout(recruitment_cycle_year:)

      expect { described_class.call(recruitment_cycle_year:) }.to raise_error(TeacherTrainingPublicAPI::SyncError)
    end
  end
end
