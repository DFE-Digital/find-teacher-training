...
describe LocationSubjectFilterComponent, type: :component do
  it 'renders the correct summary when location is used' do
    results = instance_double(ResultsView, location_filter?: true, provider_filter?: false, filter_params_for: '/')
  ...
  it 'renders the correct summary when england is used' do
    results = instance_double(ResultsView, provider_filter?: false, england_filter?: true, location_filter?: false, filter_params_for: '/')
  ...
  it 'renders the correct summary when provider is used' do
    results = instance_double(ResultsView, provider_filter?: true, england_filter?: false, location_filter?: false, filter_params_for: '/')
  ...
  it 'renders three courses correctly' do
    results = instance_double(ResultsView, provider_filter?: false, location_filter?: true, filter_params_for: '/')
