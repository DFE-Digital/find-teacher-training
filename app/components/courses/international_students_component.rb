  ...
  class InternationalStudentsComponent < ViewComponent::Base
    ...
    def visa_sponsorship_status
      if !@course.salaried? && provider.can_sponsor_student_visa
        ...
        "<p class=\"govuk-body\">If you do not already have the right to work in the UK for the duration of this course, you may need to apply for a visa. The main visa for salaried courses is the Skilled Worker visa.</p>
